...
Begin VB.Form frmBerichte10 
   Caption         =   "Berichte"
   ClientHeight    =   3840
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   7635
   Icon            =   "frmBerichte10.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   3840
   ScaleWidth      =   7635
   ...
   End
End
Attribute VB_Name = "frmBerichte10"
...
Public Sub SelectAction(Optional modal As Integer)
...
On Error GoTo Fehler
  ...
  For i = 0 To rsData.Fields.Count - 1
    If rsData.Fields(i).value & "" = "" Then
      SetDataSource = "Feld '" & rsData.Fields(i).Name & "' ohne Wert!" & Chr(13) & "Bitte weisen Sie zuvor einen Wert zu!"
      Screen.MousePointer = 0
      Exit Function
    End If
  Next i

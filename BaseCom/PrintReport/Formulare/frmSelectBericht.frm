...
Begin VB.Form frmSelectBericht 
   ...
   ClientTop       =   330
   ClientWidth     =   4710
   Icon            =   "frmSelectBericht.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3060
   ...
   Begin VB.CommandButton cmdDrucken 
      Height          =   375
      Left            =   4200
      Picture         =   "frmSelectBericht.frx":08CA
      Style           =   1  'Grafisch
      TabIndex        =   5
   ...
   End
End
Attribute VB_Name = "frmSelectBericht"
...
On Error GoTo Fehler
  ...
  With filBerichte
    ...
    frmBerichte.ReportFileName = _
    mstrReportPath & .List(.ListIndex)
    
    frmBerichte.SetDataSource rs
...
On Error GoTo Fehler
  ...
  With filBerichte
    ...
    frmBerichte.Copies = txtKopien.Text
